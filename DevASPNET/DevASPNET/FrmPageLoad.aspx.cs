...
namespace DevASPNET
{
    public partial class FrmPageLoad : System.Web.UI.Page //Page클래스로부터 상속
    {
        ...
        protected void btnPostBack_Click(object sender, EventArgs e)
        {
            ...
            ";
            ClientScript.RegisterClientScriptBlock(this.GetType(), "MyScript", strJs); //다시 게시
        }

        protected void btnNewLoad_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmPageLoad.aspx"); //처음 로드
        }
    }
}